<template>
    <div style="padding:20px;border:1px solid #ebeef5">
        ...
        <el-table :data="list" v-loading="listLoading" fit highlight-current-row style="width: 99%;margin-bottom:20px;">
            ...
            <el-table-column align="left" label="监控名称" min-width="60">
                <template slot-scope="scope">
            ...
            <el-table-column align="left" label="播放地址" min-width="100">
                <template slot-scope="scope">
...
export default {
    ...
    methods:{
        handleAdd(){
            ...
            this.$parent.$refs.addMoni.flag = 'add'
            this.$parent.$refs.addMoni.resetTemp()
        },
        getList(){
        ...
        updataDoc(row){
            this.$parent.cardVisibel = true
            this.$parent.$refs.addMoni.flag = 'updata'
            this.$parent.$refs.addMoni.form = Object.assign({},row)
            this.$parent.$refs.addMoni.form.status = (row.status === 1)?true:false
        },
    }
}
</script>
